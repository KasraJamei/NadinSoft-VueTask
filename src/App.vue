...
// State for controlling the sidebar visibility (Kept here as it manages the app-wide layout state)
const drawer = ref(true); 

const isRtl = computed(() => settingsStore.currentLocale === 'fa');

// --- Synchronization Logic (Kept here as it manages global dependencies) ---
watch(
...
// Logic for prompting user name on first visit (Kept here as it manages app-wide startup state)
onMounted(() => {
